...
public interface AttributeSet {
   ...
   *
   * <p>
   * Note that this is different than {@link #getAttributeResourceValue} in that it returns a
   * resource identifier for the attribute name; the other method returns this attribute's value as
   ...
   *
   * <p>
   * Note that this is different than {@link #getAttributeNameResource} in that it returns the value
   * contained in this attribute as a resource identifier (i.e., a value originally of the form
   * "@package:type/resource"); the other method returns a resource identifier that identifies the
  ...
  /**
   * Return the boolean value of 'attribute' that is formatted as an unsigned value. In particular,
   * the formats 0xn...n and #n...n are handled.
   *
   * @param namespace Namespace of attribute to retrieve.
   * @param attribute The attribute to retrieve.
   * @param defaultValue What to return if the attribute isn't found.
  ...
  /**
   * Return the integer value of the "id" attribute or defaultValue if there is none. Equivalent to
   * getAttributeResourceValue(null, "id", defaultValue);
   *
