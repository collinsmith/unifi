...
public class RectF {
  ...
  /**
   * Offset the rectangle to a specific (left, top) position, keeping its width
   * and height the same.
   *
  ...
  /**
   * Inset the rectangle by (dx,dy). If dx is positive, then the sides are moved
   * inwards, making the rectangle narrower. If dx is negative, then the sides
   * are moved outwards, making the rectangle wider. The same holds true for dy
   ...
   * that for a x,y to be contained: left <= x < right and top <= y < bottom. An
   * empty rectangle never contains any point.
   *
   ...
   * this rectangle is then set to that intersection) else return false and do
   ...
   * change this rectangle. No check is performed to see if either rectangle is
   ...
   * intersection, otherwise return false and do not change this rectangle. No
   * check is performed to see if either rectangle is empty. To just test for
   * intersection, use intersects()
   *
   ...
   * this rectangle to that intersection. If they do not, return false and do
   * not change this rectangle.
   */
  ...
  /**
   * Set the dst integer Rect by rounding this rectangle's coordinates to their
   ...
   * separately, and may have crossed over each other. If the edges are already
