...
public class Gravity {
  ...
  /**
   * Apply a gravity constant to an object. This supposes that the layout
   * direction is LTR.
   *
  ...
  /**
   * Apply a gravity constant to an object and take care if layout direction is
   * RTL or not.
   *
   * @param gravity         The desired placement of the object, as defined by
   *                        the constants in this class.
   * @param w               The horizontal size of the object.
   * @param h               The vertical size of the object.
   * @param container       The frame of the containing space, in which the
   *                        object will be placed.  Should be large enough to
   ...
   *                  pushes it to the right; if gravity is RIGHT it pushes it
   *                  to the left; if gravity is CENTER_HORIZONTAL it pushes it
   *                  to the right or left; otherwise it is ignored.
   * @param yAdj      Offset to apply to the Y axis.  If gravity is TOP this
   *                  pushes it down; if gravity is BOTTOM it pushes it up; if
   *                  gravity is CENTER_VERTICAL it pushes it down or up;
   ...
   *                        object will be placed.  Should be large enough to
   *                        contain the width and height of the object.
   * @param xAdj            Offset to apply to the X axis.  If gravity is LEFT
   *                        this pushes it to the right; if gravity is RIGHT it
   *                        pushes it to the left; if gravity is
   *                        CENTER_HORIZONTAL it pushes it to the right or left;
   *                        otherwise it is ignored.
   * @param yAdj            Offset to apply to the Y axis.  If gravity is TOP
   *                        this pushes it down; if gravity is BOTTOM it pushes
   *                        it up; if gravity is CENTER_VERTICAL it pushes it
   *                        down or up; otherwise it is ignored.
   * @param outRect         Receives the computed frame of the object in its
   *                        container.
   * @param layoutDirection The layout direction.
   *
   ...
   * object exists in.  This can be used after {@link #apply(int, int, int,
   * Rect, int, int, Rect)} to place the object within a visible display.  By
   * default this moves or clips the object to be visible in the display; the
   * gravity flags {@link #DISPLAY_CLIP_HORIZONTAL} and {@link
   * #DISPLAY_CLIP_VERTICAL} can be used to change this behavior.
   *
   * @param gravity  Gravity constants to modify the placement within the
   *                 display.
   * @param display  The rectangle of the display in which the object is being
   *                 placed.
   ...
   *                        being placed.
   * @param inoutObj        Supplies the current object position; returns with
   *                        it modified if needed to fit in the display.
   * @param layoutDirection The layout direction.
   *
   * @see LayoutDirection#LTR
   * @see LayoutDirection#RTL
   ...
   * RIGHT. if horizontal direction is RTL, then START will set RIGHT and END
   * will set LEFT.
   *
   * @param gravity         The gravity to convert to absolute (horizontal)
   *                        values.
   * @param layoutDirection The layout direction.
   *
